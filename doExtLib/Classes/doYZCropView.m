...
static const CGFloat MarginTop = 68.0f;

static const CGFloat MarginLeft = 20.0f;


@interface doYZCropView () <UIScrollViewDelegate, UIGestureRecognizerDelegate,doYZCropRectViewDelegate>

@property (nonatomic) UIScrollView *scrollView;
@property (nonatomic) UIView *zoomingView;
@property (nonatomic) UIImageView *imageView;

@property (nonatomic) doYZCropRectView *cropRectView;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.cropRectView = [[doYZCropRectView alloc] init];
...
- (CGRect)cappedCropRectInImageRectWithCropRectView:(doYZCropRectView *)cropRectView
{
