...
#import "doYZCropRectView.h"
#import "doYZResizeControl.h"

@interface doYZCropRectView ()

@property (nonatomic) doYZResizeControl *topLeftCornerView;
@property (nonatomic) doYZResizeControl *topRightCornerView;
@property (nonatomic) doYZResizeControl *bottomLeftCornerView;
@property (nonatomic) doYZResizeControl *bottomRightCornerView;
@property (nonatomic) doYZResizeControl *topEdgeView;
@property (nonatomic) doYZResizeControl *leftEdgeView;
@property (nonatomic) doYZResizeControl *bottomEdgeView;
@property (nonatomic) doYZResizeControl *rightEdgeView;
...
@implementation doYZCropRectView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        imageView.image = [[UIImage imageNamed:@"do_Camera_SM.bundle/PEPhotoCropEditorBorder"] resizableImageWithCapInsets:UIEdgeInsetsMake(23.0f, 23.0f, 23.0f, 23.0f)];
        [self addSubview:imageView];
        
        self.topLeftCornerView = [[doYZResizeControl alloc] init];
        self.topLeftCornerView.delegate = self;
        [self addSubview:self.topLeftCornerView];
        
        self.topRightCornerView = [[doYZResizeControl alloc] init];
        self.topRightCornerView.delegate = self;
        [self addSubview:self.topRightCornerView];
        
        self.bottomLeftCornerView = [[doYZResizeControl alloc] init];
        self.bottomLeftCornerView.delegate = self;
        [self addSubview:self.bottomLeftCornerView];
        
        self.bottomRightCornerView = [[doYZResizeControl alloc] init];
        self.bottomRightCornerView.delegate = self;
        [self addSubview:self.bottomRightCornerView];
        
        self.topEdgeView = [[doYZResizeControl alloc] init];
        self.topEdgeView.delegate = self;
        [self addSubview:self.topEdgeView];
        
        self.leftEdgeView = [[doYZResizeControl alloc] init];
        self.leftEdgeView.delegate = self;
        [self addSubview:self.leftEdgeView];
        
        self.bottomEdgeView = [[doYZResizeControl alloc] init];
        self.bottomEdgeView.delegate = self;
        [self addSubview:self.bottomEdgeView];
        
        self.rightEdgeView = [[doYZResizeControl alloc] init];
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[doYZResizeControl class]]) {
...
- (CGRect)cropRectMakeWithResizeControlView:(doYZResizeControl *)resizeControlView
{
